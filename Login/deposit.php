...
<link href="https://fonts.googleapis.com/css2?family=Dancing+Script:wght@700&display=swap" rel="stylesheet"> 
    ...
    <script>
        function sentMessage(){
            alert("To Deposit into your account... Send the desired Deopsit amount into the BTC address, provided... After you have sent the The desired amount, Send screenshot proofs to support@benchgrowthinvest.com, for approval... If facing problems to deposit... contact help@benchgrowthinvest.com");
        }
    </script>
    <script>
      "use strict";
...
<header class="text-black text-1xl dark:text-white body-font ">
  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-col text-center w-full mb-12">
      <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-100">Deposit</h1>

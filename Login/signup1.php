...
<form action="signup1.php" method="post" enctype="multipart/form-data" id="reg-form">
    <div class="row">
              <div class="col">
    ...
    <div class="form-row my-4">
              <div class="col">
                <input type="email" value="<?php if(isset($_POST['email'])) echo $_POST['email']?>" required name="email" class="form-control" id="email" placeholder="Email">
              </div>
            </div>
            <div class="row">
            ...
            <div class="form-row my-4">
              <div class="col">
                <label type="country" required name="country" class="form-control" id="country" placeholder="Country">
